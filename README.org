...
** Feature Selection
   ...
   + An Introduction to Variable and Feature Selection by Isabelle Guyon, André Elisseeff
...
*** Model Specific Explanations - Neural Networks
    ...
    + iNNvestigate neural networks! by Maximilian Alber, Sebastian Lapuschkin, Philipp Seegerer, Miriam Hägele, Kristof T. Schütt, Grégoire Montavon, Wojciech Samek, Klaus-Robert Müller, Sven Dähne, Pieter-Jan Kindermans
